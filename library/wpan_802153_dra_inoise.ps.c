...
#endif
void
wpan_802153_dra_inoise_mt ( Packet * pkptr_prev, Packet * pkptr_arriv)
	//OP_SIM_CONTEXT_ARG_OPT_COMMA
	{
	...
	/** being received.											**/
	FIN_MT (wpan_802153_dra_inoise (pkptr_prev, pkptr_arriv));
	...
	//printf("arriv_match=%d,prev_match=%d,prev_rcvd_power=%2g,arriv_rcvd_power=%2g",arriv_match,prev_match,prev_rcvd_power,arriv_rcvd_power);
