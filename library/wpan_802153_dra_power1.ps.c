...
void
wpan_802153_dra_power1_mt (OP_SIM_CONTEXT_ARG_OPT_COMMA Packet * pkptr)
	{
	...
	FIN_MT (wpan_802153_dra_power1 (pkptr));
	/*Ignore the incoming packets*/
	...
	//printf("tx_ant_gain=%2g,rcvd_power=%2g,path_loss=%2g,rx_ant_gain=%2g,in_band_tx_power=%2g",tx_ant_gain,rcvd_power,path_loss,rx_ant_gain,in_band_tx_power);
